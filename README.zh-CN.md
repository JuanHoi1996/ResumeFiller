...
| **国聘 / WeRecruit** | 政务类招聘门户 |
| **北森 Phoenix / Beisen** | 使用 Phoenix 表单项的企业招聘页（如 `form-item--phoenix` 一类） |
| **飞书 Feishu / Lark** | 飞书招聘表单（如部分基金/企业招聘页） |
| **Moka** | 以 Moka 搭建的招聘官网 |
| **中国银行（英才）** | 极深嵌套表格；以 scoped 为主，无法保证 100% 自动 |

**其它常见招聘站**（如 **猎聘、智联招聘、实习僧、前程无忧** 等）多数依赖通用控件识别，**不保证**每个子域都测过；**Hotjob、中华英才系**等同类 ATS 视页面而定。若首次未命中，请**先点进目标输入框再填一次**，或反馈字段标签与截图。
